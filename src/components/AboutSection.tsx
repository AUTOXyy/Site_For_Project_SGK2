...
export default function AboutSection() {
  const defaultImage = "https://sun9-6.userapi.com/s/v1/ig2/bvNXuC-DjqSt6Tbdt2qy1R2u3_2opSaphuu1OjcxOa71LeLm-8AvVQA1O3V9FVzjcamE72GHGjrgi-V3YqHeQtTK.jpg?quality=95&as=32x46,48x70,72x105,108x157,160x232,240x348,360x523,480x697,540x784,640x929,720x1045,1080x1568,1280x1859,1440x2091,1763x2560&from=bu&cs=1763x0";
          ...
          >
            ...
            >
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p><strong>Учреждение:</strong> МБДОУ "Детский сад № 1"</p>
