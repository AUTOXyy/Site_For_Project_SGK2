          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <div className="overflow-x-auto mb-6 -mx-6 px-6">
              <TabsList className="inline-flex w-auto min-w-full lg:grid lg:w-full lg:grid-cols-8 gap-1">
                <TabsTrigger value="pages" className="flex-col py-2 px-4 min-w-[80px]">
                  <Home className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Страницы</span>
                </TabsTrigger>
                <TabsTrigger value="publications" className="flex-col py-2 px-4 min-w-[80px]">
                  <FileText className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Публикации</span>
                </TabsTrigger>
                <TabsTrigger value="albums" className="flex-col py-2 px-4 min-w-[80px]">
                  <Image className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Альбомы</span>
                </TabsTrigger>
                <TabsTrigger value="achievements" className="flex-col py-2 px-4 min-w-[80px]">
                  <Trophy className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Достижения</span>
                </TabsTrigger>
                <TabsTrigger value="portfolio" className="flex-col py-2 px-4 min-w-[80px]">
                  <Award className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Портфолио</span>
                </TabsTrigger>
                <TabsTrigger value="reviews" className="flex-col py-2 px-4 min-w-[80px]">
                  <MessageCircle className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Отзывы</span>
                </TabsTrigger>
                <TabsTrigger value="media" className="flex-col py-2 px-4 min-w-[80px]">
                  <Headphones className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Медиа</span>
                </TabsTrigger>
                <TabsTrigger value="messages" className="flex-col py-2 px-4 min-w-[80px]">
                  <Mail className="w-4 h-4 mb-1" />
                  <span className="text-xs whitespace-nowrap">Сообщения</span>
                </TabsTrigger>
              </TabsList>
            </div>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submissionData = {
        ...
        image: coverUrl, // Добавляем также п��ле image для совместимости
        ...
        <div className="p-4 border-2 border-purple-300 rounded-xl space-y-3">
          ...
          <div>
            ...
            <Input 
              ...
              placeholder="Например: Моя катег��рия"
            />
          </div>
          <div>
            <Label>Цвет</Label>
